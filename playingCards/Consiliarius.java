...
import Logic.Player;
import tests.main.*;
public class Consiliarius extends Card implements Cloneable {

    private static final String name = "Consiliarius";
    private static final int cost = 4;    
    private static final int defense = 4;
    private static final int activatedDice = 1;
    private static final String ability = "The player picks up their character cards and\n" +
    ...
    public Consiliarius() {
        super(name, cost, defense, activatedDice, ability, type, CardCode.CONSILIARIUS);
    }
