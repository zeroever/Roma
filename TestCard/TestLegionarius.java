...
public class TestLegionarius {
    ...
    public static void main(String[] args) {
        ...
        field.layCardOnField(OPPONENT, new Turris(), 2, discardPile);
        ...
        //There is an opposing card
        //activate card
        field.getCard(CURRENT_PLAYER, 2).activate(game, null);
        ...
        currentPlayer.throwDice(battleDice);
        //There is no opposing card
        //activate card
        assert(!field.getCard(CURRENT_PLAYER, 6).activate(game, null));
